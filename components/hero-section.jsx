...
export default function HeroSection() {
  return (
    <SectionLayout id='home' className='h-screen flex items-center'>
      ...
      <div className='text-2xl sm:text-4xl md:text-6xl text-center mb-8'>
        ...
        <p className='w-full'>
          <span className='text-[#191919]'>Experienced</span> <span className='font-bold text-blue-500'>fullstack</span>
        </p>
        <p className='w-full'>
